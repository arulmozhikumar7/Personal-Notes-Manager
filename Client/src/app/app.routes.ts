...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
  path: 'drafts/:id',
  loadComponent: () => import('@/features/draft/draft-view/draft-view.component').then(m => m.DraftViewComponent),
},
 {
  path: 'notes/new',
  loadComponent: () => import('@/features/notes/note-create/note-create.component').then(m => m.NoteCreateComponent),
},{
    path: 'notes/:id',
